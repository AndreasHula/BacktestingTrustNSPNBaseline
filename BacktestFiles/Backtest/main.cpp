...
//------------------------------------------------- readout block for prepared behaviour files ------------------------------------------------------------
	ifstream ifile ("/home/hulaa/work/Modelhold/NSPNGenerativeB.bin", ios::in | ios::binary| ios::ate);	//
...
//-------------------------------------------------------------------------------------------------------------------
	...
	ofstream ofs("/home/hulaa/work/Modelhold/DeGNSPNBacktest7.bin", ofstream::out| ofstream::binary);			//output stream
	start_id= 721;
	end_id = 824;
