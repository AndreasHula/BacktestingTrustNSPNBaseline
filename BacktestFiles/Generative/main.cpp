...
//------------------------------------------------- readout block for prepared behaviour files ------------------------------------------------------------
	ifstream ifile ("/home/hulaa/work/Modelhold/Data/NSPNParamsBase.bin", ios::in | ios::binary| ios::ate);	//
...
//-------------------------------------------------------------------------------------------------------------------
	...
	ofstream ofs("/home/hulaa/work/Modelhold/NSPNGenerativeBase.bin", ofstream::out| ofstream::binary);			//output stream
	start_id= 0;
	end_id = 824;
